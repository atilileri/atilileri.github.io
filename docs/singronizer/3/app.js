    ...
    soundcloud: [
      {
        ...
        song_count: 12,
        songs: [
          {title: "Forest", artist: "System Of A Down"},
          {title: "Nujabes", artist: "Aruarian Dance"},
          {title: "Flying Lotus", artist: "Do The Astral Plane"},
          {title: "J Dilla", artist: "Donuts (Outro)"},
          {title: "MF DOOM", artist: "Accordion"}
        ]
      }
    ],
    tidal: [
